...
class SequenceStatus(enum.IntEnum):
    ...
    def get_finished_reason(status: "SequenceStatus") -> Union[str, None]:
        if status == SequenceStatus.FINISHED_STOPPED:
            ...
            finish_reason = "length"
        elif status == SequenceStatus.REJECTED:
...
class RequestMetrics:
    ...
    Attributes:
        ...
        itls: The time spent in the ITLs.
...
class Sequence:
    ...
    def __init__(
        ...
        pred_output_len: Optional[int] = None,
    ) -> None:
        self.seq_id = seq_id
        ...
        self.pred_output_len = pred_output_len
...
class SequenceGroup:
    ...
    def __init__(
        ...
        self.metrics = RequestMetrics(arrival_time=arrival_time,
                                      ...
                                      time_in_queue=None)
        # unit: ms
        self.ttft = sampling_params.ttft if sampling_params.ttft is not None else None
        self.tpot = sampling_params.tpot if sampling_params.tpot is not None else None
        self.pred_output_len: Optional[int] = None 
        self.judge_early_reject = False
    ...
    @property
    def have_judge_early_reject(self) -> bool:
        return self.judge_early_reject
    
    @property 
    def have_predicted(self) -> bool:
        return self.pred_output_len is not None
    
    @property
    def ttft_deadline(self) -> float:
        return self.ttft - (time.time() - self.metrics.arrival_time) * 1000
    ...
    def credit_earning(self, credit_delta: float) -> None:
        self.credit += credit_delta

    def credit_debiting(self) -> None:
        self.credit -= 1
